...
const SilentActive = ({ onBack }) => {
  ...
  const demoData = [
    {
      ...
      silentUsers: 1820,
      totalUsers: 4270,
      activePercentage: 0.574,
      silentPercentage: 0.426,
    },
    {
      year: 2019,
      activeUsers: 3680,
      silentUsers: 2150,
      totalUsers: 5830,
      activePercentage: 0.631,
      silentPercentage: 0.369,
    },
    {
      year: 2020,
      activeUsers: 5420,
      silentUsers: 2890,
      totalUsers: 8310,
      activePercentage: 0.652,
      silentPercentage: 0.348,
    },
    {
      year: 2021,
      activeUsers: 7250,
      silentUsers: 3650,
      totalUsers: 10900,
      activePercentage: 0.665,
      silentPercentage: 0.335,
    },
    {
      year: 2022,
      activeUsers: 9180,
      silentUsers: 4320,
      totalUsers: 13500,
      activePercentage: 0.68,
      silentPercentage: 0.32,
    },
    {
      year: 2023,
      activeUsers: 11450,
      silentUsers: 4950,
      totalUsers: 16400,
      activePercentage: 0.698,
      silentPercentage: 0.302,
    },
    {
      year: 2024,
      activeUsers: 13820,
      silentUsers: 5680,
      totalUsers: 19500,
      activePercentage: 0.709,
      silentPercentage: 0.291,
    },
  ];
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        // const response = await axios.get('http://192.168.37.177:5001/api/user/silent-active-proportions');
        ...
        setTimeout(() => {
          ...
          if (demoData.length > 0) {
            setSelectedYear(demoData[demoData.length - 1].year);
          }
          setLoading(false);
        }, 1000);
      } catch (err) {
  ...
  const drawChart = () => {
    ...
    if (chartType === "bar") {
      ...
      svg
        ...
        .attr("height", 0)
        .attr("fill", (d) =>
          d.type === "active" ? "url(#activeGradient)" : "url(#silentGradient)"
        )
        .attr("rx", 4)
        .attr("ry", 4)
        .attr("stroke", "#fff")
        ...
        .on("mouseover", function (event, d) {
          ...
          tooltip
            ...
            <div class="font-medium text-gray-800">Year: ${d.year}</div>
            <div class="${
              d.type === "active" ? "text-blue-600" : "text-gray-600"
            }">${
                d.type === "active" ? "Active" : "Silent"
              } Users: ${d.value.toLocaleString()}</div>
          `
            )
            .style("left", event.pageX + 10 + "px")
            .style("top", event.pageY - 28 + "px");
      ...
      const selectedData =
        data.find((d) => d.year === selectedYear) || data[data.length - 1];
      const pieData = [
      ...
      const path = pieG
        ...
        .attr("d", arc)
        .attr("fill", (d, i) =>
          i === 0 ? "url(#activeGradient)" : "url(#silentGradient)"
        )
        .attr("stroke", "white")
        ...
        .on("mouseover", function (event, d) {
          ...
          tooltip.transition().duration(200).style("opacity", 0.9);
          const percent = (
            (d.data.value / selectedData.totalUsers) *
            100
          ).toFixed(1);
          tooltip
            .html(
  ...
  return (
    <div className="max-w-7xl mx-auto p-5 font-sans text-center relative">
      <button
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold mt-1 text-blue-600">
                    {selectedData.totalUsers?.toLocaleString() || "N/A"}
                  </p>
                </div>
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold mt-1 text-green-600">
                    {selectedData.activeUsers?.toLocaleString() || "N/A"}
                  </p>
                </div>
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold mt-1 text-gray-600">
                    {selectedData.silentUsers?.toLocaleString() || "0"}
                  </p>
                </div>
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold mt-1 text-purple-600">
                    {formatPercentage(selectedData.activeUserProportion || 0)}
                  </p>
                </div>
            ...
            <div className="bg-white rounded-xl shadow-md overflow-hidden">
              ...
              <div className="p-6">
                <div className="space-y-4">
                  ...
                  <div className="flex justify-between items-center">
                    <span className="text-gray-600">
                      Silent User Proportion:
                    </span>
                    <span className="font-semibold text-gray-600">
                      {formatPercentage(selectedData.silentUserProportion || 0)}
                    </span>
                  </div>
                </div>
              </div>
                ...
                <div className="mb-4">
                  ...
                  <div className="w-full bg-gray-200 rounded-full h-2.5">
                    <motion.div
                      ...
                      animate={{
                        width: `${
                          (selectedData.activeUserProportion || 0) * 100
                        }%`,
                      }}
                ...
                <div>
                  ...
                  <div className="w-full bg-gray-200 rounded-full h-2.5">
                    <motion.div
                      ...
                      animate={{
                        width: `${
                          (selectedData.silentUserProportion || 0) * 100
                        }%`,
                      }}
                      transition={{ duration: 1, delay: 0.6 }}
                    ></motion.div>
          ...
          >
            ...
            <div className="mt-4 flex items-center">
              ...
              <span className="text-sm text-blue-700">
                Total user growth from {data.length > 0 ? data[0].year : "N/A"}{" "}
                to {data.length > 0 ? data[data.length - 1].year : "N/A"}:
                {data.length > 0
                  ? ` ${(
