  ...
  return (
    <div className="max-w-7xl mx-auto p-5 font-sans text-center relative">
      ...
      <motion.div
        ...
        className="mb-8"
      >
        <h1 className="text-3xl font-bold text-gray-800">Most Popular User Analysis</h1>
            ...
            <div className="flex flex-wrap gap-2">
              {['bar', 'stacked', 'pie', 'line', 'area'].map(type => (
                <button
                  ...
                  className={`px-4 py-2 rounded-md transition-all duration-200 ${chartType === type
            ...
            <div className="flex flex-wrap gap-2">
              {data.map(item => (
                <button
                  ...
                  className={`px-4 py-2 rounded-md transition-all duration-200 ${selectedYear === item.year
                      ? 'bg-blue-600 text-white font-medium shadow-md'
                      : 'bg-gray-100 text-gray-700 hover:bg-gray-200'
                    }`}
                >
